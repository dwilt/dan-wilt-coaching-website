...
define( 'IMAGES', STYLEDIR. "/img");
define( 'IMAGES_SERVER', jsd_get_stylesheet_path(). "/img");
define( 'JSDIR', STYLEDIR."/js");
define( 'CSSDIR', STYLEDIR."/css");
define( 'FONTS', STYLEDIR."/fonts");
define( 'MODDIR', STYLEDIR."/modules");
define( 'MODDIR_SERVER', jsd_get_stylesheet_path(). "/modules");


function jsd_get_home_path() {
...
function jsd_get_stylesheet_path() {
    $return = false;
    $home_path = jsd_get_home_path();
